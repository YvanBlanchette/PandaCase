				...
				return (
					<li key={step.name} className="relative overflow-hidden lg:flex-1">
						<div>
							...
							<span className={cn(index !== 0 ? "lg:pl-9" : "", "flex justify-evenly items-center px-6 py-4 text-sm font-medium")}>
								...
								<span className="ml-4 h-full mt-0.5 flex min-w-0 flex-col justify-center">
									<span className={cn("text-sm font-semibold text-zinc-700", { "text-primary": isCompleted, "text-zinc-700": isCurrent })}>{step.name}</span>
