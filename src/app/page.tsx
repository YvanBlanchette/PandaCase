					...
					<div className="col-span-2 px-6 lg:px-0 lg:pt-4">
						<div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
							...
							<p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
								Capture your favourite memories with your own, <span className="font-semibold">one-of-a-kind</span> phone case. CaseCobra allows you to protect
			...
			<section className="bg-slate-100 py-24">
				<MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
					<div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
						<h2 className="order-1 mt-2 tracing-tight text-center text-balance !leading-tight font-bold text-5xl md:6xl text-gray-900">
							What our{" "}
					...
					<div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
						...
						<div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
							<div className="flex items-center gap-12">
								<div className="flex gap-4 mt-2">
									<img src="/users/user-1.png" alt="user 1" className="rounded-full h-12 w-12 object-cover" />
									<div className="flex flex-col">
										<p className="font-semibold">Jonathan Smith</p>
										<div className="flex gap-1.5 items-center text-zinc-600">
											<Check className="h-4 w-4 stroke-[3px] text-green-600" />
											<p className="text-xs">Verified Purchase</p>
										</div>
									</div>
								</div>
							...
							<div className="text-lg leading-8">
								<p>
									"The case feels durable and I even got compliments on the design! Ha the case for two and a half months now and{" "}
									<span className="py-0.5 px-1.5 bg-slate-800 text-white">the image is super clear</span>, on the case I had before the image started fading
									into a yellow-ish color after a couple of weeks. I Love it!"
								</p>
							</div>
						</div>
						...
						<div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
							<div className="flex items-center gap-12">
								<div className="flex gap-4 mt-2">
									<img src="/users/user-4.jpg" alt="user 2" className="rounded-full h-12 w-12 object-cover" />
									<div className="flex flex-col">
										<p className="font-semibold">Josh Thompson</p>
										<div className="flex gap-1.5 items-center text-zinc-600">
											<Check className="h-4 w-4 stroke-[3px] text-green-600" />
											<p className="text-xs">Verified Purchase</p>
										</div>
							...
							<div className="text-lg leading-8">
								<p>
									"I usually keep my phone together with my keys in my pocket and that led to some pretty heavy scratchmarks on all of my last phone cases. This
									one, besides a barely noticeable scratch on the corner,{" "}
									<span className="py-0.5 px-1.5 bg-slate-800 text-white">looks brand new after about half a year</span>. I dig it."
								</p>
							</div>
						</div>
					</div>
				...
				<MaxWidthWrapper className="py-24">
					<div className="mb-12 px-6 lg:px-8">
						<div className="mx-auto max-w-2xl sm:text-center">
							<h2 className="order-1 mt-2 tracing-tight text-center text-balance !leading-tight font-bold text-5xl md:6xl text-gray-900">
								Upload you photo and get <span className="relative pb-1 px-2 bg-green-600 text-white">your own custom case</span> now!
							</h2>
						</div>
					</div>
